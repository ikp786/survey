      ...
      <div class="row">
        <div class="box-text">
                ...
                <p>– create polar questions (Yes/No questions) about current articles (the
                        “survey questions”).
                        This is
                        done via the backend;</p>
                <p>– answer the survey
                        questions.</p>
                <p>It is important to note that all analysis of the survey results such as
                        reports,
                ...
                <p>During the registration in Wage Share we ask you to provide personal data
                        ...
                        able to see
                        after responding to the survey questions; meaning; providing your personal data gives access to the
                        corresponding aggregated data in the statistics reports. It is possible at any point to remove
                        and/or add
                ...
                <p>We collect information from your mobile device about the system and model
                        of your
                        device, version of your operating system, and statistical information about the equipment of your
                        device
                        such as the processor, short-term memory, <span
                        >internal memory, application versions and similar. This information could
                        be used
                        as statistical data for improvement of our system including security policies, but not limited to it
                        alone.</p>
                <p>You can use third party services (such as Facebook and others) to share
                        ...
                        services by
                        changing the extent of public access to your personal data in those services according to their
                        Privacy
                        Policies.</p>
                ...
                <p>Without infringement of personal protection and in accordance to Dutch,
                        ...
                        storage,
                        updating or modification, retrieval, consultation, use, dissemination by means of transmission,
                        distribution
                        or display in any other form, merging, linking, as well as blocking, erasure or destruction of data
                        (“processing”).</p>
                ...
                <p>Wage Share will store personal data on a special database in the server of
                        ...
                        Conditions of
                        the special agreement between us and this provider. All provider activity related to personal data
                        is
                        regulated by the Terms and Conditions, our Privacy Policy&nbsp;and the provider’s Privacy Policy.
                        The
                        provider guarantees additional security measures to your personal data with relation to the server
                        where all
                        data are saved.</p>
                <p>Your personal data is protected from unauthorized access also from the
                        third
                        parties through our encryption during transmission, storage, and other processing of personal data
                        to
                ...
                <p>All results of public opinion become public only after the
                        ...
                        with the
                        option of user<b>`</b>s preliminary research into the topic
                        discussed
                        in the different articles.</p>
                <br>
                ...
                <p>We keep your personal data in accordance with confidentiality
                        requirements by law
                ...
                <h2>Limitations of the validity of the <span
                        >the
                ...
                <p>Wage Share has the right to change the Terms and Conditions without any
                        ...
                        be done
                        without the notice and additional consent of the users.</p>
                <br>
                ...
                <p>All the definitions in the Terms and Conditions, including “Wage Share”,
                        ...
                        be used
                        in the plural form as well as in the singular form without it having any effect on the definitions
                        themselves. The pronouns used herein shall include, where appropriate, either gender and/or both
                        singular
                        and plural.</p>
                <p>All terms and their definitions in the Terms and Conditions can be used
                        in the
                        Privacy Policy document, and vice versa, without any changes to their meaning/s. </p>
                <p>In the event that any clause in this Terms and Conditions should be
                        and/or become
                        null and void, this mere fact will not have any effect on the validity of the other clauses.
                </p>
                <p>This Terms and Conditions shall be governed and interpreted through and
                        under the
