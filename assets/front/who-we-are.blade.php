                ...
                <div class="container">
                        <div class="row">
                                <div class="col-12">
                                        <nav class="main-nav">
                                                <!-- ***** Logo Start ***** -->
                                                <a href="index.html" class="logo w-25">
                                                ...
                                                <ul class="nav">
                                                        <li class="scroll-to-section"><a href="index.html"
                                                                        >Home</a></li>
                                                        <li class="scroll-to-section"><a href="how-works.html">How it works</a></li>
                                                        <li class="scroll-to-section"><a href="" class="active">Who we are</a></li>
                ...
                <div class="container">
                        <div class="row">
                                ...
                                <div class="col-md-5 position-relative wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.25s">
                                        ...
                                        <div class="rounded">
                                                <img src="assets/images/who-wr-img.png" alt="">
                                        </div>
                                </div>
                        </div>
                </div>
                        ...
                        <section class="steps">
                                ...
                                <div class="container wow fadeIn" data-wow-duration="1s" data-wow-delay="0.25s">
                                	<ul class="int-def">
                                		...
                                		<li class="brdr-btm">
                                			<img src="assets/images/srvc.png" alt="">
                                			<h4>Services</h4>    
                                			<p>Refer to the Website</p>                            			
                                		</li>
                                		<li class="brdr-rht">
                                			<img src="assets/images/userrs.png" alt="">
                                			<h4>Services</h4>    
                                		...
                                		<li>
                                			<img src="assets/images/wag-logo.png" alt="">
                                			<h4></h4>    
                    ...
                    <!--     <section>
                        ...
                        <div class="row wha-pg m-0">
                                <div class="col-md-12">
                                        ...
                                        <p>For the purposes of this Disclaimer:</p>
                                        <ul>
                                                <li>• <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Disclaimer) refers to Wage Share.</li>
                                                <li>• <strong>Service</strong> refers to the Website.</li>
                                                <li>• <strong>You</strong> means the individual accessing the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                                                <li>• <strong>Website</strong> refers to Wage Share, accessible from <a href=""> www.wageshare.com</a></li>
                                        </ul>
                                        ...
                                        <p>
                                                ...
                                                In no event shall the Company be liable for any special, direct, indirect, consequential, or incidental damages or any damages whatsoever, whether in an action of contract, negligence or other tort, arising out of or in connection with the use of the Service or the contents of the Service. The Company reserves the right to make additions, deletions, or modifications to the contents on the Service at any time without prior notice. This Disclaimer has been created with the help of the Disclaimer Template.<br><br>
                                                The Company does not warrant that the Service is free of viruses or other harmful components.</p>
                                        ...
                                        <ul>
                                                <li>• By email: <a href="">info@wageshare.com</a></li>
                                        </ul>
                                </div>
                        </div>
                </div>
